    ...
    <div class="hero min-h-screen bg-base-200 overflow-auto">
      <div class="text-left hero-content">
        <div class="max-w-lg">
          ...
          <p class="font-mono mb-8 text-lg">👋🏽 Hi, my name is Ramez.</p>
          <p class="font-mono mb-8 text-lg">
          ...
          <p class="font-mono mb-8 text-lg">🌇 I am from Columbus, Ohio.</p>
          <p class="font-mono mb-8 text-lg">
            🧑‍🔬 I am seeking a full time Software Development position.
          </p>
          <p class="font-mono mb-1 text-lg"> I have experience in:</p>
          ...
          <p class="font-semibold mb-8 text-lg">
